...
<div class="container-fluid" style="margin-top: 30px;">
  <div class="row-fluid">
    <form action="/order/${msg}.do" name="IncomeOrderForm" class="form-horizontal" id="IncomeOrderForm" method="post"
      ...
      <div class="control-group">
        <label class="control-label" for="id_type_contract">进销项合同标识</label>
        <div class="controls">
          <input type="text" name="typeContract" id="id_type_contract" value="${bizOrderEdit.typeContract}" placeholder="这里输入进销项合同标识"/>
          <span class="help-inline"></span>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-append date" id="id_book_month" data-date="${bizOrderEdit.bookMonth}" data-date-format="yyyy-mm-dd"
            ...
            <input class="span2" type="text" name="bookMonth" readonly style="width: 193px;"
                   value="${bizOrderEdit.bookMonth}"
                   placeholder="请选择成立时间"/>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="provider" id="id_provider" value="${bizOrderEdit.provider}" placeholder="这里输入供应商"/>
          <span class="help-inline"></span>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="customer" id="id_customer" value="${bizOrderEdit.customer}" placeholder="这里输入客户"/>
          <span class="help-inline"></span>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="paymentMoney" id="id_payment_money" value="${bizOrderEdit.paymentMoney}" placeholder="这里输入付款金额"/>
          <span class="help-inline"></span>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" name="freightOrderCode" id="id_freight_order_code" value="${bizOrderEdit.freightOrderCode}" placeholder="这里输入发货单号"/>
          <span class="help-inline"></span>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  $("#id_material_code").autocomplete({
    ...
    select: function (event, ui) {
      ...
      $("#id_comment").val(ui.item.comment);
      $("#id_material_desc").val(ui.item.content);
      return false;
    }
