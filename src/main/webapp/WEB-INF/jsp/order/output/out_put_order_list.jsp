...
<div class="container-fluid" style="margin-top: 30px;">
  ...
  <table id="out_put_order_table_id" class="display nowrap" cellspacing="0" width="100%">
    <thead>
    <tr>
  ...
  <a class="btn btn-small btn-success " onclick="addOutPutOrder();">新增</a>
</div>
...
<script type="text/javascript" src="/static/js/order/out_put_order_list.js"></script>
